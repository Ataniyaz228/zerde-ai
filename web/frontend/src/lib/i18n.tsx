...
const translations = {
  ru: {
    ...
    hero_eyebrow: "НПА РК · Правовая экспертиза",
    // Двуязычный титул — инвариантен к выбору языка (на титуле документа РК всегда обе строки).
    hero_formal_ru: "Правовая экспертиза законопроектов",
    hero_formal_kz: "Заңнамалық сараптама",
    ...
    hero_stats: "38 кодексов · 20 000+ норм · adilet.zan.kz",
    ...
    stage_ingest_short: "Загрузка документа",
    acc_d1: "Принимаем законопроект — DOCX, PDF или TXT. Ничего не нужно готовить заранее.",
    acc_d2: "Разбираем текст на отдельные проверяемые утверждения — что именно документ заявляет.",
    acc_d3: "Находим релевантные нормы в adilet.zan.kz и открытых источниках.",
    acc_d4: "Сверяем каждое утверждение с дословной цитатой из закона. Нет цитаты — нет подтверждения.",
    acc_d5: "Собираем отчёт: вердикт по каждому пункту, ссылка на статью и общая оценка надёжности.",
    ...
    upload_hint: "PDF, DOC, DOCX, TXT — до 25 МБ",
    ...
    report_machine_translation: "Машинный перевод · первоисточник на русском",
    report_translating: "Готовим казахскую версию…",
    // Verdict dashboard
    ...
    verdict_headline_good: "Противоречий не выявлено",
    verdict_headline_bad: "Выявлены опровержения",
    verdict_headline_warn: "Недостаточно данных для проверки",
    verdict_needs_review: "требует внимания юриста",
    ...
    pw_exhibit_label: "Доказательство",
    pw_claim_label: "Утверждение",
    how_lead: "От загрузки до вердикта со ссылкой — пять прозрачных шагов.",
  ...
  kz: {
    ...
    hero_eyebrow: "ҚР НҚА · Құқықтық сараптама",
    hero_formal_ru: "Правовая экспертиза законопроектов",
    hero_formal_kz: "Заңнамалық сараптама",
    ...
    hero_stats: "38 кодекс · 20 000+ норма · adilet.zan.kz",
    ...
    stage_ingest_short: "Құжатты жүктеу",
    acc_d1: "Заң жобасын қабылдаймыз — DOCX, PDF немесе TXT. Алдын ала дайындаудың қажеті жоқ.",
    acc_d2: "Мәтінді жеке тексерілетін тұжырымдарға бөлеміз — құжат нақты нені мәлімдейді.",
    acc_d3: "adilet.zan.kz және ашық дереккөздерден тиісті нормаларды табамыз.",
    acc_d4: "Әрбір тұжырымды заңнан дәлме-дәл дәйексөзбен салыстырамыз. Дәйексөз жоқ — растау жоқ.",
    acc_d5: "Есеп жинаймыз: әр тармаққа вердикт, бапқа сілтеме және жалпы сенімділік бағасы.",
    ...
    upload_hint: "PDF, DOC, DOCX, TXT — 25 МБ дейін",
    ...
    report_machine_translation: "Машиналық аударма · бастапқы нұсқа орыс тілінде",
    report_translating: "Қазақша нұсқасы дайындалуда…",
    // Verdict dashboard
    ...
    verdict_headline_good: "Қайшылықтар анықталмады",
    verdict_headline_bad: "Теріске шығарулар анықталды",
    verdict_headline_warn: "Тексеруге дерек жеткіліксіз",
    verdict_needs_review: "заңгердің назарын талап етеді",
    ...
    pw_exhibit_label: "Дәлел",
    pw_claim_label: "Тұжырым",
    how_lead: "Жүктеуден сілтемелі вердиктке дейін — бес ашық қадам.",
