...
- Найди содержание статьи в корпусе
- Если статья о другом → CONTRADICTED
- Если статья не найдена → UNVERIFIED
...
- Используй знания вне корпуса ТОЛЬКО для пометки CONTRADICTED (ты знаешь что 87-IV не существует)
